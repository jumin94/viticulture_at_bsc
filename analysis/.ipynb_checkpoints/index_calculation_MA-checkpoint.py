# This code evaluates the indices associated with the remote driver responses for MA season
...
## En este primer caso calculamos la diferenceia entre SST históricas y futuras y luego calculamos el campo asimétrico para generar los índices
